...
export type SignUp = {
  __typename?: "Mutation";
  signUp: { __typename?: "User"; id: string; name?: string | null; email: string };
};
...
export type Login = {
  __typename?: "Mutation";
  login: { __typename?: "User"; id: string; name?: string | null; email: string };
};
...
export type CreateUser = {
  __typename?: "Mutation";
  createUser: { __typename?: "User"; email: string; name?: string | null; id: string };
};
...
export function getSdk(
  ...
  return {
    SignUp(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SignUp>(SignUpDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "SignUp",
    ...
    Login(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Login>(LoginDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Login",
    ...
    GetUser(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUser>(GetUserDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetUser",
